...
function render(){
  ...
  if(S.phase==="hinweis")    return viewHinweis(me);
  if(S.phase==="raten")      return viewRaten(me);
  if(S.phase==="seite")      return viewSeite(me);
  if(S.phase==="aufloesung") return viewAufloesung(me);
